...
3. ~~Reemplazar en `admin/config.yml` el `api_key` de Cloudinary~~ — hecho 2026-09-09 (`689586654285591`). El `api_secret` que pegó Luis en el chat no se guardó en ningún archivo ni commit; no lo usa el media_library "unsigned".
